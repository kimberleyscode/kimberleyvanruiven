...
const NL: HomeInhoud = {
  ...
  gedachten: {
    ...
    kaarten: [
      ...
      { sym: 7, cat: 'Machine learning · NLP', titel: 'Ik labelde tweets op haatspraak, en het model leerde de verkeerde les', status: null, href: '/artikelen/tweets-labelen-en-de-verkeerde-les', linktekst: 'Lees het artikel →' },
      { sym: 5, cat: 'Leeslijst', titel: 'De boeken die mijn kijk op AI en menselijkheid vormden', status: null, href: '/artikelen/boeken-die-mijn-kijk-vormden', linktekst: 'Lees het artikel →' },
    ],
  },
...
const EN: HomeInhoud = {
  ...
  gedachten: {
    ...
    kaarten: [
      ...
      { sym: 7, cat: 'Machine learning · NLP', titel: 'Labelling tweets for hate speech, and what the models actually learned', status: null, href: 'https://github.com/kimberleyscode/Master-Thesis-HateSpeech-Twitter/blob/master/BERT_sentence_classification.ipynb', linktekst: 'See the BERT notebook →' },
