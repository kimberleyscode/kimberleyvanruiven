  ...
  return (
    ...
    >
      <section>
        ...
        <p>
          The risk here sits in the data the model was trained on. If skewed patterns are present, the model will pick them up flawlessly. For my master’s thesis I studied algorithms that detect online hate speech, and that turned out to be exactly the problem: models reproducing the prejudices in their training data, with all the consequences that has for the people they judge.
        </p>
      </section>
      ...
      <section>
        ...
        <p>
          Generative AI, such as ChatGPT and Claude, produces new text, images or audio of its own. The output is open: you don’t know in advance exactly what will come out, and the model presents a guess with the same confidence as a fact. That makes it powerful for writing, summarising and thinking things through with you, and at the same time unreliable as a source of truth.
        </p>
        <p>
      ...
      <section>
        ...
        <p>
          The law looks at AI this way too. The EU AI Act sorts applications by risk, and a machine learning model that passes judgement on people, in hiring or credit applications for instance, lands in the high-risk category soon enough. A writing assistant helping you with a quote does not.
        </p>
        <p>
          In practice the difference means this: with machine learning you ask questions about the data and the decision. What was it trained on, how often does it get things wrong, and what happens to someone who is misjudged? With generative AI you ask questions about the use. Which data goes in, who checks the output, and do your people know what the tool can and can’t do? Anyone who knows which type sits inside a tool knows which of those two conversations is needed.
        </p>
      </section>
      ...
      <section>
        <h2>Start here</h2>
        <p>
          Walk through the AI tools in your organisation with one question per tool: does this predict something, or does this create something? That single distinction tells you what to watch for. Want to do it together, and get a picture of where you stand under the AI Act while you’re at it? That’s what the <Link href="/en/services/ai-act-readiness-scan">AI Act readiness scan</Link> is for. Questions about your situation? Email <a href="mailto:info@kimberleyvanruiven.nl">info@kimberleyvanruiven.nl</a>.
        </p>
      </section>
    </C2Tekstpagina>
  );
