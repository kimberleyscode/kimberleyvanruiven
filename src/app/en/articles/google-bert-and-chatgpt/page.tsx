...
export const metadata: Metadata = {
  ...
  description: 'Google BERT has understood language since 2019; ChatGPT and Claude write text of their own. What NLP models and generative models share, and when small is the better choice.',
};
...
export default function BertAndChatGPTArticle() {
  return (
    ...
    >
      ...
      <section>
        <h2>More in common than you’d think</h2>
        <p>
