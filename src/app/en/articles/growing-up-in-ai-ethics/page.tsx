...
export const metadata: Metadata = {
  ...
  description: 'Between AI principles and practice lies a gap. The AI ethics maturity model from Erasmus University shows you where you stand, across six dimensions.',
};
...
export default function MaturityArticle() {
  return (
    <C2Tekstpagina
      ...
      intro={
        <p>
          More and more organisations have AI principles: we use AI responsibly, transparently and with an eye for people. Fine words, and usually sincerely meant. But between principles and practice lies a gap, and that gap is rarely measured. Researchers at Erasmus University have developed a model for it: the AI ethics maturity model.
        </p>
      }
    >
      <section>
      ...
      <section>
        ...
        <p>
          It begins with awareness and culture: does your team talk at all about what AI should and shouldn’t be doing? Then policy, ground rules short enough to actually be read. Then governance: who is responsible when a system gets it wrong, and do they know it? The fourth dimension is communication and training, which is a particularly live issue in the Netherlands, because the AI Act calls for demonstrable AI literacy. The fifth is your processes: are ethical questions asked while systems are being chosen and built, or only once something goes wrong? And finally tooling, the aids that make it easy for your people to do the right thing.
        </p>
      </section>
      ...
      <section>
        <h2>Start here</h2>
        <p>
          Want to know where your organisation stands? This model is one of the instruments in my <Link href="/en/services/ai-act-readiness-scan">AI Act readiness scan</Link>: besides the legal state of play you get a picture of your maturity across these six dimensions, with the logical next step alongside it. Questions? Email <a href="mailto:info@kimberleyvanruiven.nl">info@kimberleyvanruiven.nl</a>.
        </p>
        <p>
