...
const ARTICLES: Kaart[] = [
  {
    ...
    label: 'NLP',
    titel: 'The language model you have been using for years without knowing it',
    intro: 'Google BERT has understood language since 2019; ChatGPT and Claude write for themselves. On what they share, and when a small model is the better choice.',
    datum: 'July 2026',
  },
  {
  ...
  },
  {
    ...
    intro: 'When an AI project disappoints, the model gets the blame. Usually the problem sits around it: in the data, the fit with your systems, and who is watching.',
    datum: 'July 2026',
  },
  {
    slug: 'growing-up-in-ai-ethics',
    label: 'AI ethics',
    titel: 'Growing up in AI ethics, and why you do not need a perfect score',
    intro: 'Between AI principles and practice lies a gap. The maturity model from Erasmus University makes visible where you stand, across six dimensions.',
    datum: 'July 2026',
  },
  {
    ...
    intro: 'Every technology carries the incentives of its makers within it. On humane technology, human-seeming AI, and the manifesto I hold my work to.',
    datum: 'July 2026',
  },
  {
    slug: 'the-ai-act-for-smes',
    label: 'EU AI Act',
    titel: 'What the EU AI Act asks of you as a business owner (and what it does not)',
    intro: 'The AI Act sounds like something for the lawyers at large companies. It touches you too, though the practice turns out to be manageable once you know what to look for.',
    datum: 'July 2026',
  },
  {
    ...
    intro: 'Most data leaks through AI come not from hackers but from well-meant prompts. Three rules of thumb you can apply today.',
    datum: 'July 2026',
  },
  {
    ...
    label: 'Research · NLP',
    titel: 'Algorithms built to spot online hate, and biased themselves',
