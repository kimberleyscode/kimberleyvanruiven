...
export default function ArchitectureArticle() {
  return (
    <C2Tekstpagina
      ...
      intro={
        <p>
          When an AI project disappoints, the model usually gets the blame. Too stupid, too generic, not ready for our work yet. But zoom in on failed projects and you see something else: the model did what it was meant to do, and nobody had properly thought through everything around it. Most AI problems are architecture problems.
        </p>
      }
    >
      <section>
        ...
        <p>
          The research institute RAND put the figure at around eighty per cent of AI projects failing, twice as often as other IT projects. Rarely because the model falls short: today’s language models are the same building blocks for everyone, and they are impressively good. What goes wrong sits before and after. Data that isn’t in order. A tool standing apart from the real work, so that nobody opens it. Output nobody looks at until a mistake lands with a client. And, before any of that, a goal never stated more sharply than &quot;something with AI&quot;.
        </p>
      </section>
      ...
      <section>
        ...
        <p>
          The projects that do succeed almost always start small: one process, one clear measure of success, and a person who has the final say. That is not caution; it is design. A small system that holds up can be extended; a large system that wobbles can only be repaired. And because with a small system you know exactly what goes in and what comes out, the ethical side takes care of itself: you can explain what it does, and for whom.
        </p>
      </section>
      ...
      <section>
        <h2>Start here</h2>
        <p>
          Do you have an AI idea, or a tool that didn’t deliver what was expected of it? Then look at the four questions above before you try a different model. This is exactly the work I do in <Link href="/en/services/tailored-ai-solutions">tailored AI solutions</Link>: get the system right first, scale up afterwards. Tell me what you have in mind at <a href="mailto:info@kimberleyvanruiven.nl">info@kimberleyvanruiven.nl</a>.
        </p>
      </section>
    </C2Tekstpagina>
  );
