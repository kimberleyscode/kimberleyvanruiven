...
export const metadata: Metadata = {
  alternates: { canonical: '/concept-2/artikelen' },
  ...
  robots: "noindex, nofollow", // conceptversie; de oude /artikelen blijft voorlopig de echte
};
  ...
  return (
    ...
    >
      {ARTIKELEN.map((a) => {
        ...
        return <Link className="c2-artikel-kaart" href={a.href ?? `/concept-2/artikelen/${a.slug}`} key={a.titel}>{inhoud}</Link>;
      })}
    </C2Tekstpagina>
  );
}
