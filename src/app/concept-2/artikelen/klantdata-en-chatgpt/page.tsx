...
export const metadata: Metadata = {
  alternates: { canonical: '/concept-2/artikelen/klantdata-en-chatgpt' },
    ...
    >
      ...
      <section>
        ...
        <ul>
          ...
          <li>Leer je team deze regels: dat is meteen een deel van je <Link href="/concept-2/artikelen/ai-act-voor-ondernemers">AI-geletterdheidsplicht onder de AI Act</Link>.</li>
        </ul>
        <p>
